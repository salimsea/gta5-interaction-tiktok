...
public class GTAVWebhookScript : Script
{
    ...
    public GTAVWebhookScript()
    {
        ...
        _chibakuTensei = new ChibakuTensei();
        _randomCar = new RandomCar();
    ...
    private void ProcessCommand(CommandInfo command)
    {
        switch (command.cmd)
        {
            ...
            case "explode_vehicles_self":
                {
                    _explodeVehicles.Execute(isSelf: true);
                    break;
                }
    ...
    private void ProcessCommandOld(CommandInfo command)
    {
        switch (command.cmd)
        {
            case "kill":
